describe("test", () => {
  ...
  //   cy.get('#startDate').type('2023-02-28')
  ...
  //   cy.xpath('/html/body/div[2]/div/div[3]/div/div/div[1]/div/button').click()
    ...
    // cy.xpath('//*[@id="root"]/section/section/main/div/div[2]/div/div[1]/div[3]/a/span').click();
  ...
  //  cy.xpath('//*[@id="root"]/section/section/main/div/div[2]/div/div[1]/div[5]/a/span').click()
  ...
  //   cy.contains('Show Fields').click()
   ...
   //  cy.get('#deadlineLastDate').type('2023-03-23',{force:true})
   //  cy.get('#deadlineDescription').type('Dit is een test')


   // Deadlines

  // cy.xpath('//*[@id="root"]/section/section/main/div/div[2]/div/div[1]/div[6]/a').click()
  ...
  //    cy.xpath('//*[@id="root"]/section/section/main/div/div[2]/div/div[1]/div[7]/a').click()
